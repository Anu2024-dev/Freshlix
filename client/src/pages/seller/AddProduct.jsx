...
//                                 <img className="max-w-24 cursor-pointer" src={files[index] ? URL.createObjectURL(files[index]) : assets.upload_area} width={100} height={100} />
//                             </label>
//                         ))}
//                     </div>
//                 </div>
...
//                         {assets.categories.map((item, index) => (
    ...
    return (
        <div className="no-scrollbar flex-1 h-[95vh] overflow-y-scroll flex flex-col justify-between">
            ...
            >
                ...
                {/* Button */}
                <button className="px-8 py-2.5 bg-green-500 text-white font-medium rounded">
                    ADD
                </button>
            </form>
        </div>
