...
//     return (
//         <div onClick={() => setShowUserLogin(false)} className="fixed bottom-0 left-0 right-0 z-30 flex items-center text-sm text-gray-600 bg-black/50">
...
//                     </p>
//                 )}
//                 <button className="bg-primary hover:bg-primary-dullndigo-600 transition-all text-white w-full py-2 rounded-md cursor-pointer">
